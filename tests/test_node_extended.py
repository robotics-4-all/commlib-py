...
class TestNodeExtended(unittest.TestCase):
    ...
    def test_node_name_property(self):
        ...
        node = Node(node_name="my.sensor.node", connection_params=self.conn_params)
    ...
    def test_node_with_heartbeats(self):
        ...
        node = Node(
            node_name="test", connection_params=self.conn_params, heartbeats=True
        )
    ...
    def test_node_publishers_tracking(self):
        ...
        node.create_publisher(msg_type=SensorMessage, topic="sensor.temperature")
    ...
    def test_node_subscribers_tracking(self):
        ...
        node.create_subscriber(
            msg_type=SensorMessage, topic="sensor.data", on_message=lambda msg: None
        )
    ...
    def test_node_rpc_clients_tracking(self):
        ...
        node.create_rpc_client(msg_type=MathRPC, rpc_name="math.multiply")
    ...
    def test_node_connection_params(self):
        ...
        node = Node(node_name="test", connection_params=self.conn_params)
