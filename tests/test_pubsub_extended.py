...
class TestPublisherExtended(unittest.TestCase):
    ...
    def test_publisher_creation(self):
        ...
        pub = node.create_publisher(msg_type=DummyMessage, topic="test.topic")
    ...
    def test_publisher_topic(self):
        ...
        pub = node.create_publisher(msg_type=DummyMessage, topic="sensors.temperature")
...
class TestSubscriberExtended(unittest.TestCase):
    ...
    def test_subscriber_creation(self):
        ...
        sub = node.create_subscriber(
            msg_type=DummyMessage, topic="test.topic", on_message=lambda msg: None
        )
    ...
    def test_subscriber_topic(self):
        ...
        sub = node.create_subscriber(
            msg_type=DummyMessage, topic="sensors.humidity", on_message=lambda msg: None
        )
    ...
    def test_subscriber_callback(self):
        ...
        sub = node.create_subscriber(
            msg_type=DummyMessage, topic="test.topic", on_message=callback
        )
