...
def main():
    ...
    parser.add_argument("--rpc-name", type=str, default="test.rpc.add_two_ints", help="RPC name to use")
    parser.add_argument("--count", type=int, default=5, help="Number of RPC calls to make")
    ...
    rpc_client = node.create_rpc_client(
        msg_type=AddTwoInts,
        rpc_name=args.rpc_name
    )
